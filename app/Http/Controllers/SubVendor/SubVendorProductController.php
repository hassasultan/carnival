...
class SubVendorProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($product) {
            $products = Product::where('user_id', Auth::id())->get();
            $view = view('dashboard.subvendor.products.table', compact('products'))->render();
    ...
    public function show($id)
    {
        ...
        return view('dashboard.subvendor.products.show', compact('product'));
    }
