                ...
                <div class="col-md-12">
                    ...
                    <div class="card shadow">
                        <div class="card-body">
                            ...
                            <!-- Table Data -->
                            <div id="tableData">
                                @include('dashboard.vendor.costumes.table')
                            </div>
                        </div>
                    </div>
                </div> <!-- data table -->
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.editCostumeBtn', function() {
                ...
                $.ajax({
                    url: '{{ route('vendor.costumes.edit', ':id') }}'.replace(':id', costumeId),
                    type: 'GET',
            ...
            $('#createCostumeForm').submit(function(event) {
                ...
                $.ajax({
                    url: '{{ route('vendor.costumes.store') }}',
                    type: 'POST',
            ...
            $('#editcostumeForm').submit(function(event) {
                ...
                var formData = new FormData($(this)[0]); // Use FormData object to include media files
                console.log('formDataformData', formData);
                var url = '{{ route('vendor.costumes.update', ':id') }}'.replace(':id', costumeId);
