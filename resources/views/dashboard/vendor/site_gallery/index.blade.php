                            ...
                            <table class="table table-bordered mt-3">
                                ...
                                @foreach ($siteGalleries as $siteGallery)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('vendor_site_gallery.show', $siteGallery->id) }}" class="btn btn-info">Show</a>
                                            <a href="{{ route('vendor_site_gallery.edit', $siteGallery->id) }}" class="btn btn-primary">Edit</a>
                                            <form action="{{ route('vendor_site_gallery.destroy', $siteGallery->id) }}" method="POST" style="display:inline-block;">
                                                @csrf
                                                @method('DELETE')
