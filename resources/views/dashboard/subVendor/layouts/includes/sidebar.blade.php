      ...
      <ul class="navbar-nav flex-fill w-100 mb-2">
        <li class="nav-item dropdown">
          ...
          <ul class="collapse list-unstyled w-100" id="dashboard">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="{{ route('permissions.index') }}"><span class="ml-1 item-text">Permissions</span></a>
            </li>
            <li class="nav-item active">
              <a class="nav-link" href="{{ route('role_permissions.index') }}"><span class="ml-1 item-text">RolesPermissions</span></a>
            </li>
            <li class="nav-item active">
      ...
      <ul class="navbar-nav flex-fill w-100 mb-2">
        <li class="nav-item dropdown">
          ...
          <ul class="collapse list-unstyled w-100" id="ui-elements">
            ...
            <li class="nav-item">
              <a class="nav-link" href="../dist/ui-typograpy.html"><span class="ml-1 item-text">Typograpy</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../dist/ui-icons.html"><span class="ml-1 item-text">Icons</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../dist/ui-buttons.html"><span class="ml-1 item-text">Buttons</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../dist/ui-notification.html"><span class="ml-1 item-text">Notifications</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../dist/ui-modals.html"><span class="ml-1 item-text">Modals</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../dist/ui-tabs-accordion.html"><span class="ml-1 item-text">Tabs & Accordion</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../dist/ui-progress.html"><span class="ml-1 item-text">Progress</span></a>
            </li>
          </ul>
        </li>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="collapse list-unstyled w-100" id="forms">
            <li class="nav-item">
              <a class="nav-link" href="../dist/form_elements.html"><span class="ml-1 item-text">Basic Elements</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../dist/form_advanced.html"><span class="ml-1 item-text">Advanced Elements</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../dist/form_validation.html"><span class="ml-1 item-text">Validation</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../dist/form_wizard.html"><span class="ml-1 item-text">Wizard</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../dist/form_layouts.html"><span class="ml-1 item-text">Layouts</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../dist/form_upload.html"><span class="ml-1 item-text">File upload</span></a>
            </li>
          </ul>
        </li>
        <li class="nav-item dropdown">
          ...
          <ul class="collapse list-unstyled w-100" id="tables">
            <li class="nav-item">
              <a class="nav-link" href="../dist/table_basic.html"><span class="ml-1 item-text">Basic Tables</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../dist/table_advanced.html"><span class="ml-1 item-text">Advanced Tables</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../dist/table_datatables.html"><span class="ml-1 item-text">Data Tables</span></a>
            </li>
          </ul>
        </li>
        <li class="nav-item dropdown">
          ...
          <ul class="collapse list-unstyled w-100" id="charts">
            <li class="nav-item">
              <a class="nav-link" href="../dist/chart-inline.html"><span class="ml-1 item-text">Inline Chart</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../dist/chart-chartjs.html"><span class="ml-1 item-text">Chartjs</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../dist/chart-apexcharts.html"><span class="ml-1 item-text">ApexCharts</span></a>
            </li>
            <!-- <li class="nav-item">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="collapse list-unstyled w-100" id="maps">
            <li class="nav-item">
              <a class="nav-link" href="../dist/map-vector.html"><span class="ml-1 item-text">Vector Maps</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../dist/map-mapbox.html"><span class="ml-1 item-text">Mapbox</span></a>
            </li>
          </ul>
        </li>
      </ul>
      ...
      <ul class="navbar-nav flex-fill w-100 mb-2">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="collapse list-unstyled w-100" id="contact">
            <li class="nav-item">
              <a class="nav-link" href="../dist/contacts-list-1.html"><span class="ml-1">Contact - List 1</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../dist/contacts-list-2.html"><span class="ml-1">Contact - List 2</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../dist/contacts-grid.html"><span class="ml-1">Contact - Grid</span></a>
            </li>
            <li class="nav-item">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="collapse list-unstyled w-100" id="profile">
            ...
            <li class="nav-item">
              <a class="nav-link" href="../dist/profile-notification.html"><span class="ml-1">Notifications</span></a>
            </li>
          </ul>
        </li>
        <li class="nav-item dropdown">
          ...
          <ul class="collapse list-unstyled w-100" id="fileman">
            ...
            <li class="nav-item">
              <a class="nav-link" href="../dist/files-grid-1.html"><span class="ml-1">Files - Grid 1</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../dist/files-grid-2.html"><span class="ml-1">Files - Grid 2</span></a>
            </li>
          </ul>
        </li>
        <li class="nav-item dropdown">
          ...
          <ul class="collapse list-unstyled w-100" id="support">
            ...
            <li class="nav-item">
              <a class="nav-link" href="../dist/support-ticket-detail.html"><span class="ml-1">Ticket Detail</span></a>
            </li>
            <li class="nav-item">
      ...
      <ul class="navbar-nav flex-fill w-100 mb-2">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="collapse list-unstyled w-100" id="auth">
            ...
            <li class="nav-item">
              <a class="nav-link" href="../dist/auth-resetpw.html"><span class="ml-1">Reset Password</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../dist/auth-confirm.html"><span class="ml-1">Confirm Password</span></a>
            </li>
          </ul>
        </li>
        <li class="nav-item dropdown">
          ...
          <ul class="collapse list-unstyled w-100" id="layouts">
            ...
            <li class="nav-item">
              <a class="nav-link" href="../dist/index-horizontal-1.html"><span class="ml-1 item-text">Top Navigation 1</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../dist/index-horizontal-2.html"><span class="ml-1 item-text">Top Navigation 2</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../dist/index-vertical-1.html"><span class="ml-1 item-text">Sidebar</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../dist/index-vertical-2.html"><span class="ml-1 item-text">Sidebar - Condensed</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../dist/index-vertical-3.html"><span class="ml-1 item-text">Sidebar - Two Column</span></a>
            </li>
            
            <li class="nav-item">
              <a class="nav-link" href="../dist/index-boxed.html"><span class="ml-1 item-text">Boxed</span></a>
            </li>
          </ul>
        </li>
      </ul>
