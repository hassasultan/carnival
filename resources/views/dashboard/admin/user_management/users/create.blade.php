                            ...
                            <form method="POST" action="{{ route('users.register') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input id="height" type="number"
                                                ...
                                                value="{{ old('height') }}" min="50" max="250">
                                            @error('height')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input id="weight" type="number"
                                                ...
                                                value="{{ old('weight') }}" min="20" max="200">
                                            @error('weight')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input id="bust" type="number"
                                                class="form-control @error('bust') is-invalid @enderror" name="bust"
                                                value="{{ old('bust') }}" min="50" max="150">
                                            @error('bust')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="waist" type="number"
                                                class="form-control @error('waist') is-invalid @enderror" name="waist"
                                                value="{{ old('waist') }}" min="40" max="150">
                                            @error('waist')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="hips" type="number"
                                                class="form-control @error('hips') is-invalid @enderror" name="hips"
                                                value="{{ old('hips') }}" min="50" max="200">
                                            @error('hips')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                ...
                                                <label class="custom-file-label" for="image" id="image_label">Choose
                                                    file</label>
                                            </div>
                                            @error('image')
                                                <span class="invalid-feedback d-block">{{ $message }}</span>
                                            @enderror
                                            <small class="form-text text-muted">Supported formats: JPG, PNG, GIF (Max:
                                                2MB)</small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="package"
                                                class="form-control select2 @error('package_id') is-invalid @enderror"
                                ...
                                <div class="row mb-4" id="package-features" style="display: none;">
                                    <div class="col-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group list-group mb-3 shadow" id="ecommerce-box"
                                                    style="display: none;">
                                                    <div class="list-group-item">
                                                        <div class="row align-items-center">
                                                            <div class="col">
                                                                <strong class="mb-2">E-Commerce</strong>
                                                                <small class="text-muted d-block">Sell products
                                                                    online</small>
                                                            </div>
                                                            <div class="col-auto">
                                                ...
                                                <div class="form-group list-group mb-3 shadow" id="music-box"
                                                    style="display: none;">
                                                    <div class="list-group-item">
                                                        <div class="row align-items-center">
                                                            <div class="col">
                                                                <strong class="mb-2">Music Upload</strong>
                                                                <small class="text-muted d-block">Upload and manage
                                                                    music</small>
                                                            </div>
                                                            <div class="col-auto">
                                                                <div class="custom-control custom-switch">
                                                ...
                                                <div class="form-group list-group mb-3 shadow" id="appointment-box"
                                                    style="display: none;">
                                                    <div class="list-group-item">
                                                        <div class="row align-items-center">
                                                            <div class="col">
                                                                <strong class="mb-2">Appointments</strong>
                                                                <small class="text-muted d-block">Manage
                                                                    appointments</small>
                                                            </div>
                                                            <div class="col-auto">
                                                                <div class="custom-control custom-switch">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group list-group mb-3 shadow" id="events-box"
                                                    style="display: none;">
                                                    <div class="list-group-item">
                                                        <div class="row align-items-center">
                                                            <div class="col">
                                                                <strong class="mb-2">Events</strong>
                                                                <small class="text-muted d-block">Create and manage
                                                                    events</small>
                                                            </div>
                                                            <div class="col-auto">
                                                                <div class="custom-control custom-switch">
                                                                    <input type="checkbox" class="custom-control-input"
                                                                        value="1" id="events" name="events">
                                                                    <label class="custom-control-label"
                                                                        for="events"></label>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="form-group list-group mb-3 shadow" id="ad_space-box"
                                                    style="display: none;">
                                                    <div class="list-group-item">
                                                        <div class="row align-items-center">
                                                            <div class="col">
                                                                <strong class="mb-2">Advertisement Space</strong>
                                                                <small class="text-muted d-block">Display
                                                ...
                                                <div class="form-group list-group mb-3 shadow" id="blogging-box"
                                                    style="display: none;">
                                                    <div class="list-group-item">
                                                        <div class="row align-items-center">
                                                            <div class="col">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="shop_email" type="email"
                                                ...
                                                name="shop_email" value="{{ old('shop_email') }}" required
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="shop_address">Shop Address <span
                                                    class="text-danger">*</span></label>
                                            <input id="shop_address" type="text"
                                                class="form-control @error('shop_address') is-invalid @enderror"
                                                name="shop_address" value="{{ old('shop_address') }}" required
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="shop_phone" type="text"
                                                ...
                                                name="shop_phone" value="{{ old('shop_phone') }}" required
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="continent"
                                                class="form-control select2 @error('continent') is-invalid @enderror"
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="shop_insta" type="url"
                                                class="form-control @error('shop_insta') is-invalid @enderror"
                                                name="shop_insta" value="{{ old('shop_insta') }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="shop_facebook" type="url"
                                                class="form-control @error('shop_facebook') is-invalid @enderror"
                                                name="shop_facebook" value="{{ old('shop_facebook') }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="shop_youtube" type="url"
                                                class="form-control @error('shop_youtube') is-invalid @enderror"
                                                name="shop_youtube" value="{{ old('shop_youtube') }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="shop_twitter" type="url"
                                                class="form-control @error('shop_twitter') is-invalid @enderror"
                                                name="shop_twitter" value="{{ old('shop_twitter') }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="shop_tiktok" type="url"
                                                class="form-control @error('shop_tiktok') is-invalid @enderror"
                                                name="shop_tiktok" value="{{ old('shop_tiktok') }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="shop_wa_business_page" type="url"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="shop_linkedin" type="url"
                                                class="form-control @error('shop_linkedin') is-invalid @enderror"
                                                name="shop_linkedin" value="{{ old('shop_linkedin') }}"
                                    ...
                                    <div class="col-12">
                                        <div id="bannerSection">
                                            <div class="banner-item card mb-3">
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        <label for="banner">Banner Image <span
                                                                class="text-danger">*</span></label>
                                                        <div class="custom-file">
                                                            <input type="file" class="custom-file-input"
                                                                id="banner_${bannerIndex}"
                                                                name="banner_files[${bannerIndex}]" required
                                                                accept="image/*,video/*">
                                                            <label class="custom-file-label"
                                                                for="banner_${bannerIndex}">Choose file</label>
                                                        </div>
                                                        <small class="form-text text-muted">Supported formats: JPG, PNG,
                                                            GIF, MP4 (Max: 10MB)</small>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            name="banners[${bannerIndex}][button_text]"
                                    ...
                                    <div class="col-12">
                                        <div id="sponsorsSection">
                                            <div class="sponsor-item card mb-3">
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        <label for="sponsor_logo">Sponsor Logo <span
                                                                class="text-danger">*</span></label>
                                                        <div class="custom-file">
                                                            <input type="file" class="custom-file-input"
                                                                id="sponsor_logo_${sponsorIndex}"
                                                                name="sponsor_logos[${sponsorIndex}]" required
                                                                accept="image/*">
                                                            <label class="custom-file-label"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="sponsor_name_${sponsorIndex}">Sponsor
                                                                    Name</label>
                                                                <input type="text" class="form-control"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="sponsor_website_${sponsorIndex}">Website
                                                                    URL</label>
                                                                <input type="url" class="form-control"
                                                                    name="sponsors[${sponsorIndex}][website]"
