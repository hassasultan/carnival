                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select id="ecommerce" name="ecommerce" class="form-control" required>
                                        <option value="1" {{ $package->ecommerce == '1' ? 'selected' : '' }}>True
                                        </option>
                                        <option value="0" {{ $package->ecommerce == '0' ? 'selected' : '' }}>False
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group mb-3">
                                    ...
                                    <select id="product" name="product" class="form-control" required>
                                        <option value="1" {{ $package->product == '1' ? 'selected' : '' }}>True
                                        </option>
                                        <option value="0" {{ $package->product == '0' ? 'selected' : '' }}>False
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group mb-3">
                                    ...
                                    <select id="costume" name="costume" class="form-control" required>
                                        <option value="1" {{ $package->costume == '1' ? 'selected' : '' }}>True
                                        </option>
                                        <option value="0" {{ $package->costume == '0' ? 'selected' : '' }}>False
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group mb-3">
                                    ...
                                    <select id="events" name="events" class="form-control" required>
                                        <option value="1" {{ $package->events == '1' ? 'selected' : '' }}>True
                                        </option>
                                        <option value="0" {{ $package->events == '0' ? 'selected' : '' }}>False
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group mb-3">
                                    ...
                                    <select id="music" name="music" class="form-control" required>
                                        ...
                                        <option value="0" {{ $package->music == '0' ? 'selected' : '' }}>False
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group mb-3">
                                    ...
                                    <select id="appointment" name="appointment" class="form-control" required>
                                        <option value="1" {{ $package->appointment == '1' ? 'selected' : '' }}>True
                                        </option>
                                        <option value="0" {{ $package->appointment == '0' ? 'selected' : '' }}>False
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group mb-3">
                                    ...
                                    <select id="ad_space" name="ad_space" class="form-control" required>
                                        <option value="1" {{ $package->ad_space == '1' ? 'selected' : '' }}>True
                                        </option>
                                        <option value="0" {{ $package->ad_space == '0' ? 'selected' : '' }}>False
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group mb-3">
                                    ...
                                    <select id="blogging" name="blogging" class="form-control" required>
                                        <option value="1" {{ $package->blogging == '1' ? 'selected' : '' }}>True
                                        </option>
                                        <option value="0" {{ $package->blogging == '0' ? 'selected' : '' }}>False
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group mb-3">
