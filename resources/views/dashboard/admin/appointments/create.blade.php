                    ...
                    <form id="appointmentForm" method="POST" action="{{ route('appointments.store') }}">
                        ...
                        <div class="slot-container">
                            <div class="form-group slot-input">
                                <label for="appointment_datetime">Slot #1</label>
                                <div class="row">
                                    <div class="col-sm-11">
                                        <input class="datetime-local form-control" type="datetime-local"
                                            name="appointment_datetime[]" required disabled>
                                    </div>
                                    <div class="col-sm-1">
                                        <button type="button" id="addSlot" class="btn btn-primary plus-btn"
                                            disabled>+</button>
                                    </div>
                                </div>
                            </div>
...
@section('bottom_script')
    <script>
        $(document).ready(function() {
            var slotNumber = 2; // Initialize slot number
