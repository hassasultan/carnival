                        ...
                        <div class="block-content">
                            <ul class="ui-categori">
                                ...
                                <li class="parent">
                                    <a href="">
                                        <span class="icon"><img
                                                src="{{ asset('shopAssets/images/icon/index3/nav-cat3.png') }}"
                                                alt="nav-cat"></span>
                                        Smartphone & Tablets
                                    </a>
                                    <span class="toggle-submenu"></span>
                                ...
                                <li>
                                    <a href="">
                                        <span class="icon"><img
                                                src="{{ asset('shopAssets/images/icon/index3/nav-cat5.png') }}"
                                                alt="nav-cat"></span>
                                ...
                                <li>
                                    <a href="">
                                        <span class="icon"><img
                                                src="{{ asset('shopAssets/images/icon/index3/nav-cat6.png') }}"
                                                alt="nav-cat"></span>
                                        Toys & Hobbies
                                    </a>
                                </li>
                                <li>
                                    <a href="">
                                        <span class="icon"><img
                                                src="{{ asset('shopAssets/images/icon/index3/nav-cat7.png') }}"
                                                alt="nav-cat"></span>
                                ...
                                <li>
                                    <a href="">
                                        <span class="icon"><img
                                                src="{{ asset('shopAssets/images/icon/index3/nav-cat8.png') }}"
                                                alt="nav-cat"></span>
                                        Laptops & Accessories
                                    </a>
                                </li>
                                <li>
                                    <a href="">
                                        <span class="icon"><img
                                                src="{{ asset('shopAssets/images/icon/index3/nav-cat9.png') }}"
                                                alt="nav-cat"></span>
                                        Jewelry & Watches
                                    </a>
                                </li>
                                <li>
                                    <a href="">
                                        <span class="icon"><img
                                                src="{{ asset('shopAssets/images/icon/index3/nav-cat10.png') }}"
                                                alt="nav-cat"></span>
                                        Flashlights & Lamps
                                    </a>
                                </li>
                                <li>
                                    <a href="">
                                        <span class="icon"><img
                                                src="{{ asset('shopAssets/images/icon/index3/nav-cat11.png') }}"
                                                alt="nav-cat"></span>
                                        Cameras & Photo
                                    </a>
                                </li>
                    ...
                    <div class="block-slide-main slide-opt-12">
                        ...
                        <div class="owl-carousel " data-nav="true" data-dots="true" data-margin="0" data-items='1'
                            ...
                            <div class="item item1">
                                <img src="{{ asset('shopAssets/images/media/index12/slide1.jpg') }}" alt="slide1"
                                    class="img-slide">
                            ...
                            <div class="item item2">
                                <img src="{{ asset('shopAssets/images/media/index12/slide2.jpg') }}" alt="slide1"
                                    class="img-slide">
                                <div class="description">
                                    <span class="subtitle ">HOT discount of the week</span>
                                    <span class="title">fashion 2015 </span>
                            ...
                            <div class="item item3">
                                <img src="{{ asset('shopAssets/images/media/index12/slide3.jpg') }}" alt="slide1"
                                    class="img-slide">
                                <div class="description">
                                    <span class="subtitle ">HOT discount of the week</span>
                                    <span class="title">fashion 2015 </span>
                            ...
                            <div class="item item4">
                                <img src="{{ asset('shopAssets/images/media/index12/slide4.jpg') }}" alt="slide1"
                                    class="img-slide">
                                <div class="description">
                                    <span class="subtitle ">HOT discount of the week</span>
                                    <span class="title">fashion 2015 </span>
                    ...
                    <div class="col-right">
                        <div class="banner-slide">
                            <a href="" class="box-img"><img
                                    src="{{ asset('shopAssets/images/media/index12/banner-slide.jpg') }}"
                                    alt="img"></a>
                        </div>
                        ...
                        <div class="block-logo-brand">
                            ...
                            "1200":{"items":1}
                                ...
                                <div class="item">
                                    <img src="{{ asset('shopAssets/images/media/index12/logo-brand.jpg') }}"
                                        alt="img">
                                </div>
                                <div class="item">
                                    <img src="{{ asset('shopAssets/images/media/index12/logo-brand.jpg') }}"
        ...
        <div class="block-banner-main-opt12">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <a href="" class="box-img"><img
                                src="{{ asset('shopAssets/images/media/index12/banner1.jpg') }}" alt="img"></a>
                        <!-- <div class="item item1">
                    ...
                    <div class="col-md-4">
                        <a href="" class="box-img"><img
                                src="{{ asset('shopAssets/images/media/index12/banner2.jpg') }}" alt="img"></a>
                        <!-- <div class="item item2">
                    ...
                    <div class="col-md-4">
                        <a href="" class="box-img"><img
                                src="{{ asset('shopAssets/images/media/index12/banner3.jpg') }}" alt="img"></a>
                        <!-- <div class="item item3">
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-lg-9">
                    ...
                    <div class="block-floor-products block-floor-products-opt12 floor-products1" id="floor0-1">
                            ...
                            <div class="box-categori dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="">
                                            <span class="icon">
                                                <img src="{{ asset('shopAssets/images/icon/index12/nav-cat1.png') }}"
                                                    alt="nav-cat" class="img-show">
                                                <img src="{{ asset('shopAssets/images/icon/index12/nav-cat1-hover.png') }}"
                                                    alt="nav-cat" class="img-hover">
                                            </span>
                                            Electronics
                                        </a>
                                    </li>
                                    <li>
                                        <a href="">
                                            <span class="icon">
                                                <img src="{{ asset('shopAssets/images/icon/index12/nav-cat2.png') }}"
                                                    alt="nav-cat" class="img-show">
                                                <img src="{{ asset('shopAssets/images/icon/index12/nav-cat2-hover.png') }}"
                                                    alt="nav-cat" class="img-hover">
                                            </span>
                                            Sports & Outdoors
                                        </a>
                                    ...
                                    <li>
                                        <a href="">
                                            <span class="icon">
                                                <img src="{{ asset('shopAssets/images/icon/index12/nav-cat3.png') }}"
                                                    alt="nav-cat" class="img-show">
                                                <img src="{{ asset('shopAssets/images/icon/index12/nav-cat3-hover.png') }}"
                                                    alt="nav-cat" class="img-hover">
                                            </span>
                                            Smartphone & Tablets
                                        </a>
                                    ...
                                    <li>
                                        <a href="">
                                            <span class="icon">
                                                <img src="{{ asset('shopAssets/images/icon/index12/nav-cat4.png') }}"
                                                    alt="nav-cat" class="img-show">
                                                <img src="{{ asset('shopAssets/images/icon/index12/nav-cat4-hover.png') }}"
                                                    alt="nav-cat" class="img-hover">
                                            </span>
                                            Health & Beauty
                                        </a>
                                    ...
                                    <li>
                                        <a href="">
                                            <span class="icon">
                                                <img src="{{ asset('shopAssets/images/icon/index12/nav-cat5.png') }}"
                                                    alt="nav-cat" class="img-show">
                                                <img src="{{ asset('shopAssets/images/icon/index12/nav-cat5-hover.png') }}"
                                                    alt="nav-cat" class="img-hover">
                                            </span>
                                            Bags, Shoes & Accessories
                                        </a>
                                    ...
                                    <li>
                                        <a href="">
                                            <span class="icon">
                                                <img src="{{ asset('shopAssets/images/icon/index12/nav-cat6.png') }}"
                                                    alt="nav-cat" class="img-show">
                                                <img src="{{ asset('shopAssets/images/icon/index12/nav-cat6-hover.png') }}"
                                                    alt="nav-cat" class="img-hover">
                                            </span>
                                            Toys & Hobbies
                                        </a>
                                    ...
                                    <li>
                                        <a href="">
                                            <span class="icon">
                                                <img src="{{ asset('shopAssets/images/icon/index12/nav-cat7.png') }}"
                                                    alt="nav-cat" class="img-show">
                                                <img src="{{ asset('shopAssets/images/icon/index12/nav-cat7-hover.png') }}"
                                                    alt="nav-cat" class="img-hover">
                                            </span>
                                            Computers & Networking
                                        </a>
                                    ...
                                    <li>
                                        <a href="">
                                            <span class="icon">
                                                <img src="{{ asset('shopAssets/images/icon/index12/nav-cat8.png') }}"
                                                    alt="nav-cat" class="img-show">
                                                <img src="{{ asset('shopAssets/images/icon/index12/nav-cat8-hover.png') }}"
                                                    alt="nav-cat" class="img-hover">
                                            </span>
                                            Laptops & Accessories
                                        </a>
                                    ...
                                    <li>
                                        <a href="">
                                            <span class="icon">
                                                <img src="{{ asset('shopAssets/images/icon/index12/nav-cat9.png') }}"
                                                    alt="nav-cat" class="img-show">
                                                <img src="{{ asset('shopAssets/images/icon/index12/nav-cat9-hover.png') }}"
                                                    alt="nav-cat" class="img-hover">
                                            </span>
                                            Jewelry & Watches
                                        </a>
                                    ...
                                    <li>
                                        <a href="">
                                            <span class="icon">
                                                <img src="{{ asset('shopAssets/images/icon/index12/nav-cat10.png') }}"
                                                    alt="nav-cat" class="img-show">
                                                <img src="{{ asset('shopAssets/images/icon/index12/nav-cat10-hover.png') }}"
                                                    alt="nav-cat" class="img-hover">
                                            </span>
                                            Flashlights & Lamps
                                        </a>
                                    ...
                                    <li>
                                        <a href="">
                                            <span class="icon">
                                                <img src="{{ asset('shopAssets/images/icon/index12/nav-cat11.png') }}"
                                                    alt="nav-cat" class="img-show">
                                                <img src="{{ asset('shopAssets/images/icon/index12/nav-cat11-hover.png') }}"
                                                    alt="nav-cat" class="img-hover">
                                            </span>
                                            Cameras & Photo
                                        </a>
                        ...
                        <div class="block-content">
                            ...
                            <div class="col-banner">
                                <a href="" class="box-img"><img
                                        src="{{ asset('shopAssets/images/media/index12/baner-floor1.jpg') }}"
                                        alt="baner-floor"></a>
                                <div class="description">
                                                    ...
                                                    <div class="product-item-info">
                                                        <div class="product-item-detail">
                                                            <strong class="product-item-name"><a
                                                                    href="{{ route('get.products.detail', $row->slug) }}">{{ $row->title }}
                                                                </a></strong>
                                                            <div class="product-item-price">
                                                        ...
                                                        <div class="product-item-photo">
                                                            <a class="product-item-img"
                                                                href="{{ route('get.products.detail', $row->slug) }}">
                                                                @if ($row->image != '' && $row->image != null)
                                                                    <img src="{{ asset('productImage/' . $row->image) }}"
                                                                        alt="product name">
                                                                @else
                                                                    <img src="{{ asset('shopAssets/images/media/index12/floor3-1.jpg') }}"
                                                                        alt="product name">
                                                                @endif
                                                            </a>
                    ...
                    <div class="block-floor-products block-floor-products-opt12 floor-products2" id="floor0-2">
                                ...
                                <div class="dropdown-menu">
                                    <ul>
                                        <li role="presentation" class="active"><a href="#floor2-1" role="tab"
                                                data-toggle="tab">Best Seller </a></li>
                                        <li role="presentation"><a href="#floor2-2" role="tab" data-toggle="tab">New
                                                Arrivals </a></li>
                        ...
                        <div class="block-content">
                            ...
                            <div class="col-banner">
                                <a href="" class="box-img"><img
                                        src="{{ asset('shopAssets/images/media/index12/baner-floor2.jpg') }}"
                                        alt="baner-floor"></a>
                                <div class="description">
                                    <span class="subtitle ">end off the week </span>
                                    <span class="title"> big sale</span>
                                                ...
                                                <div class=" product-item product-item-opt-12">
                                                    <div class="product-item-info">
                                                        <div class="product-item-detail">
                                                            ...
                                                            <div class="product-item-price">
                                                                <span class="price">${{ $row->old_price }}</span>
                                                            </div>
                                                        </div>
                                                        <div class="product-item-photo">
                                                            <a class="product-item-img"
                    ...
                    <div class="block-floor-products block-floor-products-opt12 floor-products3" id="floor0-3">
                        ...
                        <div class="block-content">
                            ...
                            <div class="col-banner">
                                <a href="" class="box-img"><img
                                        src="{{ asset('shopAssets/images/media/index12/baner-floor3.jpg') }}"
                                        alt="baner-floor"></a>
                                <div class="description">
                                                        ...
                                                        <div class="product-item-photo">
                                                            <a class="product-item-img"
                                                                ...
                                                                {{-- <img alt="product name"
                                                                    src="{{ asset('shopAssets/images/media/index12/floor3-1.jpg') }}"> --}}
                                                                @if ($row->image != '' && $row->image != null)
                                                                    <img src="{{ asset('productImage/' . $row->image) }}"
                                                                        alt="product name">
                                                                @else
                                                    ...
                                                    <div class="product-item-info">
                                                        ...
                                                        <div class="product-item-photo">
                                                            <a class="product-item-img"
                                                                ...
                                                                {{-- <img
                                                                    alt="product name"
                                                                    src="{{ asset('shopAssets/images/media/index12/floor3-2.jpg') }}"> --}}
                                                                @if ($row->image != '' && $row->image != null)
                                                                    <img src="{{ asset('productImage/' . $row->image) }}"
                                                                        alt="product name">
                                                                @else
                ...
                <div class="col-md-4 col-lg-3">
                        ...
                        <div class="block-content">
                            ...
                            "1200":{"items":3}
                                ...
                                <div class="item ">
                                    <div class="photo">
                                        <span class="img"><img
                                                src="{{ asset('shopAssets/images/media/index12/Testimonials1.jpg') }}"
                                                alt="img"></span>
                                    </div>
                                </div>
                                <div class="item ">
                                    <div class="photo">
                                        <span class="img"><img
                                                src="{{ asset('shopAssets/images/media/index12/Testimonials2.jpg') }}"
                                                alt="img"></span>
                                    </div>
                                </div>
                                <div class="item ">
                                    <div class="photo">
                                        <span class="img"><img
                                                src="{{ asset('shopAssets/images/media/index12/Testimonials3.jpg') }}"
                                                alt="img"></span>
                                    </div>
                                </div>
                            ...
                            "1200":{"items":1}
                                ...
                                <div class="item">
                                    ...
                                    <div class="info">
                                        <p> <img src="{{ asset('shopAssets/images/media/index12/img-des.png') }}"
                                                alt="img" class="icon">
                    ...
                    <div class="block-banner-sidebar block-banner-sidebar-opt12 effect-banner3">
                        <a href="" class="box-img"><img
                                src="{{ asset('shopAssets/images/media/index12/banner-sidebar.jpg') }}"
                                alt="img"></a>
                    </div>
        ...
        <div class="block-banner-bottom-opt12">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a href="" class="box-img"><img
                                src="{{ asset('shopAssets/images/media/index12/banner4.jpg') }}" alt="img"></a>
                        <!-- <div class="item item3">
                    ...
                    <div class="col-md-6">
                        <a href="" class="box-img"><img
                                src="{{ asset('shopAssets/images/media/index12/banner5.jpg') }}" alt="img"></a>
                        <!-- <div class="item item2">
        ...
        <div class="block-categori-opt12">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="item item1"
                            style="background-image: url({{ asset('shopAssets/images/media/index12/bg-categories1.png') }});">
                            <div class="title">
                                <span>categories </span>
                    ...
                    <div class="col-md-4">
                        <div class="item item2"
                            style="background-image: url({{ asset('shopAssets/images/media/index12/bg-categories2.png') }});">
                            <div class="title">
                                <span>categories </span>
                    ...
                    <div class="col-md-4">
                        <div class="item item3"
                            style="background-image: url({{ asset('shopAssets/images/media/index12/bg-categories3.png') }});">
                            <div class="title">
                                <span>categories </span>
                    ...
                    "1200":{"items":2}
                        ...
                        <div class="blog-item">
                            <div class="blog-photo">
                                <a href=""><img src="{{ asset('shopAssets/images/media/index12/blog1.jpg') }}"
                                        alt="blog"></a>
                        ...
                        <div class="blog-item">
                            <div class="blog-photo">
                                <a href=""><img src="{{ asset('shopAssets/images/media/index12/blog2.jpg') }}"
                                        alt="blog"></a>
        ...
        <div class="block-brand-op12">
            <div class="container">
                <div class="owl-carousel" data-nav="true" data-dots="false" data-margin="30" data-loop="true"
                    ...
                    <div class="item">
                        <a href=""><img src="{{ asset('shopAssets/images/media/index12/brand1.jpg') }}"
                                alt="brand"></a>
                    </div>
                    <div class="item">
                        <a href=""><img src="{{ asset('shopAssets/images/media/index12/brand2.jpg') }}"
                                alt="brand"></a>
                    </div>
                    <div class="item">
                        <a href=""><img src="{{ asset('shopAssets/images/media/index12/brand3.jpg') }}"
                                alt="brand"></a>
                    </div>
                    <div class="item">
                        <a href=""><img src="{{ asset('shopAssets/images/media/index12/brand4.jpg') }}"
                                alt="brand"></a>
                    </div>
                    <div class="item">
                        <a href=""><img src="{{ asset('shopAssets/images/media/index12/brand5.jpg') }}"
                                alt="brand"></a>
                    </div>
                    <div class="item">
                        <a href=""><img src="{{ asset('shopAssets/images/media/index12/brand6.jpg') }}"
                                alt="brand"></a>
                    </div>
                    <div class="item">
                        <a href=""><img src="{{ asset('shopAssets/images/media/index12/brand7.jpg') }}"
                                alt="brand"></a>
                    </div>
                    <div class="item">
                        <a href=""><img src="{{ asset('shopAssets/images/media/index12/brand6.jpg') }}"
