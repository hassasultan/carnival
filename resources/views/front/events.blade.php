    ...
    <div class="swiper-container main-slider" data-autoplay="5000" data-loop="1" data-speed="900" data-center="0" data-slides-per-view="1">
        <div class="swiper-wrapper">
            <div class="swiper-slide active" data-val="0"> 
              <div class="clip">
                 <div class="bg bg-bg-chrome act" style="background-image:url(https://carnivalguide.co/travel/img/home_9/slide_1a.jpg)">
                 </div>
              </div>
                      ...
                      <div class="col-md-12">
                        <div class="main-title style-1 vert-title">
                          <div class="top-weather-info delay-1">
                              <img src="https://carnivalguide.co/travel/img/theme-1/logo.fw.png" alt="">
                          </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-6">
                                    <a href="#" class="c-button b-60 bg-blue-3 hv-transparent delay-2 fr"><img src="https://carnivalguide.co/travel/img/loc_icon.png" alt=""><span>view our tours</span></a>											
                                </div>
                                <div class="col-xs-12 col-sm-6">
               ...
               <b>hotels</b>	
                <a href="#" class="arrow-down"><i class="fa fa-angle-down"></i></a>
                 <ul class="nav-tabs tpl-tabs tabs-style-1">
                    <li class="active click-tabs"><a href="#one" data-toggle="tab" aria-expanded="false">Monday</a></li>
...
<div class="col-mob-12 col-xs-6 col-sm-6 col-md-3 no-padding">
    <div class="tp_entry style-2">
        <div class="tp_image">
            <img class="center-image" src="https://carnivalguide.co/travel/img/home_9/preview_1a.jpg" alt="">
        </div>
...
<div class="col-mob-12 col-xs-6 col-sm-6 col-md-3 no-padding">
    <div class="tp_entry style-2">
        <div class="tp_image">
            <img class="center-image" src="https://carnivalguide.co/travel/img/home_9/preview_2a.jpg" alt="">
        </div>
        <div class="tp_content">
              <div class="rate-wrap clearfix">
                  <div class="rate">
...
<div class="col-mob-12 col-xs-6 col-sm-6 col-md-3 no-padding">
    <div class="tp_entry style-2">
        <div class="tp_image">
            <img class="center-image" src="https://carnivalguide.co/travel/img/home_9/preview_3a.jpg" alt="">
        </div>
        <div class="tp_content">
              <div class="rate-wrap clearfix">
                  <div class="rate">
...
<div class="col-mob-12 col-xs-6 col-sm-6 col-md-3 no-padding">
    <div class="tp_entry style-2">
        <div class="tp_image">
            <img class="center-image" src="https://carnivalguide.co/travel/img/home_9/preview_4a.jpg" alt="">
        </div>
        <div class="tp_content">
              <div class="rate-wrap clearfix">
                  <div class="rate">
...
<div class="col-mob-12 col-xs-6 col-sm-6 col-md-3 no-padding">
    <div class="tp_entry style-2">
        <div class="tp_image">
            <img class="center-image" src="https://carnivalguide.co/travel/img/home_9/preview_5a.jpg" alt="">
        </div>
        <div class="tp_content">
              <div class="rate-wrap clearfix">
                  <div class="rate">
...
<div class="col-mob-12 col-xs-6 col-sm-6 col-md-3 no-padding">
    <div class="tp_entry style-2">
        <div class="tp_image">
            <img class="center-image" src="https://carnivalguide.co/travel/img/home_9/preview_6a.jpg" alt="">
        </div>
        <div class="tp_content">
              <div class="rate-wrap clearfix">
                  <div class="rate">
...
<div class="col-mob-12 col-xs-6 col-sm-6 col-md-3 no-padding">
    <div class="tp_entry style-2">
        <div class="tp_image">
            <img class="center-image" src="https://carnivalguide.co/travel/img/home_9/preview_7a.jpg" alt="">
        </div>
        <div class="tp_content">
              <div class="rate-wrap clearfix">
                  <div class="rate">
...
<div class="col-mob-12 col-xs-6 col-sm-6 col-md-3 no-padding">
    <div class="tp_entry style-2">
        <div class="tp_image">
            <img class="center-image" src="https://carnivalguide.co/travel/img/home_9/preview_8a.jpg" alt="">
        </div>
        <div class="tp_content">
              <div class="rate-wrap clearfix">
                  <div class="rate">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-3">
            <div class="world-city black-hover">
                ...
                <img class="center-image" src="https://carnivalguide.co/travel/img/home_9/city_1a.jpg" alt="">
                <div class="vertical-align">
        ...
        <div class="col-xs-12 col-sm-6 col-md-3">
            <div class="world-country">
                <img class="center-image" src="https://carnivalguide.co/travel/img/home_9/country_1.png" alt="">
                <div class="vertical-align">
        ...
        <div class="col-xs-12 col-sm-6 col-md-3">
            <div class="world-city black-hover">
                <div class="tour-layer delay-1"></div>
                <img class="center-image" src="https://carnivalguide.co/travel/img/home_9/city_2a.jpg" alt="">
                <div class="vertical-align">
        ...
        <div class="col-xs-12 col-sm-6 col-md-3">
            <div class="world-country">
                <img class="center-image" src="https://carnivalguide.co/travel/img/home_9/country_2.png" alt="">
                <div class="vertical-align">
        ...
        <div class="col-xs-12 col-sm-6 col-md-3">
            <div class="world-city black-hover">
                <div class="tour-layer delay-1"></div>
                <img class="center-image" src="https://carnivalguide.co/travel/img/home_9/city_3a.jpg" alt="">
                <div class="vertical-align">
        ...
        <div class="col-xs-12 col-sm-6 col-md-3">
            <div class="world-country">
                <img class="center-image" src="https://carnivalguide.co/travel/img/home_9/country_3.png" alt="">
                <div class="vertical-align">
        ...
        <div class="col-xs-12 col-sm-6 col-md-3">
            <div class="world-city black-hover">
                <div class="tour-layer delay-1"></div>
                <img class="center-image" src="https://carnivalguide.co/travel/img/home_9/city_4a.jpg" alt="">
                <div class="vertical-align">
        ...
        <div class="col-xs-12 col-sm-6 col-md-3">
            <div class="world-country">
                <img class="center-image" src="https://carnivalguide.co/travel/img/home_9/country_4.png" alt="">
                <div class="vertical-align">
...
<div class="container">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="hotel-small style-2 clearfix">
                <a class="hotel-img black-hover" href="#">
                    <img class="img-responsive radius-0" src="https://carnivalguide.co/travel/img/home_9/cruise_1a.jpg" alt="">
                    <div class="tour-layer delay-1"></div>        						
                </a>
            ...
            <div class="hotel-small style-2 clearfix">
                <a class="hotel-img black-hover" href="#">
                    <img class="img-responsive radius-0" src="https://carnivalguide.co/travel/img/home_9/cruise_2a.jpg" alt="">
                    <div class="tour-layer delay-1"></div>        						
                </a>
                <div class="hotel-desc">
                    <h5><span class="color-dark-2"><strong>$273</strong> / person</span></h5>	
            ...
            <div class="hotel-small style-2 clearfix">
                <a class="hotel-img black-hover" href="#">
                    <img class="img-responsive radius-0" src="https://carnivalguide.co/travel/img/home_9/cruise_3a.jpg" alt="">
                    <div class="tour-layer delay-1"></div>        						
                </a>
                <div class="hotel-desc">
                    <h5><span class="color-dark-2"><strong>$273</strong> / person</span></h5>
            ...
            <div class="hotel-small style-2 clearfix">
                <a class="hotel-img black-hover" href="#">
                    <img class="img-responsive radius-0" src="https://carnivalguide.co/travel/img/home_9/cruise_4a.jpg" alt="">
                    <div class="tour-layer delay-1"></div>        						
                </a>
                <div class="hotel-desc">
                    <h5><span class="color-dark-2"><strong>$273</strong> / person</span></h5>
        ...
        <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="hotel-small style-2 clearfix">
                <a class="hotel-img black-hover" href="#">
                    <img class="img-responsive radius-0" src="https://carnivalguide.co/travel/img/home_9/cruise_5a.jpg" alt="">
                    <div class="tour-layer delay-1"></div>        						
                </a>
                <div class="hotel-desc">
                    <h5><span class="color-dark-2"><strong>$273</strong> / person</span></h5>
            ...
            <div class="hotel-small style-2 clearfix">
                <a class="hotel-img black-hover" href="#">
                    <img class="img-responsive radius-0" src="https://carnivalguide.co/travel/img/home_9/cruise_6a.jpg" alt="">
                    <div class="tour-layer delay-1"></div>        						
                </a>
                <div class="hotel-desc">
                    <h5><span class="color-dark-2"><strong>$273</strong> / person</span></h5>
            ...
            <div class="hotel-small style-2 clearfix">
                <a class="hotel-img black-hover" href="#">
                    <img class="img-responsive radius-0" src="https://carnivalguide.co/travel/img/home_9/cruise_7a.jpg" alt="">
                    <div class="tour-layer delay-1"></div>        						
                </a>
                <div class="hotel-desc">
                    <h5><span class="color-dark-2"><strong>$273</strong> / person</span></h5>
            ...
            <div class="hotel-small style-2 clearfix">
                <a class="hotel-img black-hover" href="#">
                    <img class="img-responsive radius-0" src="https://carnivalguide.co/travel/img/home_9/cruise_8a.jpg" alt="">
                    <div class="tour-layer delay-1"></div>        						
                </a>
                <div class="hotel-desc">
                    <h5><span class="color-dark-2"><strong>$273</strong> / person</span></h5>
        ...
        <div class="col-xs-12 col-sm-12 col-md-4">
            <div class="item-block style-5 hover-blue-3">
                <img class="center-image" src="https://carnivalguide.co/travel/img/home_9/special1.jpg" alt="">
                <div class="tour-layer delay-1"></div>
                <div class="vertical-align">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-3">
            <div class="icon-block style-3 bg-white">
                ...
                <img class="icon-img" src="https://carnivalguide.co/travel/img/home_9/icon_1a.jpg" alt="">
                <div class="rate-wrap clearfix">
                        <div class="rate">
                        <span class="fa fa-star color-yellow"></span>
                        <span class="fa fa-star color-yellow"></span>
        ...
        <div class="col-xs-12 col-sm-6 col-md-3">
            <div class="icon-block style-3 bg-white">
                <div class="icon-price color-dark-2">from <strong>$750</strong></div>
                <img class="icon-img" src="https://carnivalguide.co/travel/img/home_9/icon_2a.jpg" alt="">
                <div class="rate-wrap clearfix">
                        <div class="rate">
                        <span class="fa fa-star color-yellow"></span>
                        <span class="fa fa-star color-yellow"></span>
        ...
        <div class="col-xs-12 col-sm-6 col-md-3">
            <div class="icon-block style-3 bg-white">
                <div class="icon-price color-dark-2">from <strong>$750</strong></div>
                <img class="icon-img" src="https://carnivalguide.co/travel/img/home_9/icon_3a.jpg" alt="">
                <div class="rate-wrap clearfix">
                        <div class="rate">
                        <span class="fa fa-star color-yellow"></span>
                        <span class="fa fa-star color-yellow"></span>
        ...
        <div class="col-xs-12 col-sm-6 col-md-3">
            <div class="icon-block style-3 bg-white">
                <div class="icon-price color-dark-2">from <strong>$750</strong></div>
                <img class="icon-img" src="https://carnivalguide.co/travel/img/home_9/icon_4a.jpg" alt="">
                <div class="rate-wrap clearfix">
                        <div class="rate">
                        <span class="fa fa-star color-yellow"></span>
                        <span class="fa fa-star color-yellow"></span>
