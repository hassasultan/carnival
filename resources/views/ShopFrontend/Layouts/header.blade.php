    ...
    <div class="wrapper">
        ...
        <header class="site-header header-opt-4 cate-show">
            ...
            <div class="header-top">
                <div class="container">
                    ...
                    <ul class="nav-left">
                        ...
                        <li><a href=""><img src="{{asset('shopAssets/images/media/index3/log-face.png')}}" alt="log-face"></a></li>
                    </ul>
                            ...
                            <div class="block-minicart dropdown">
                                <a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
                                    ...
                                    <span class="counter qty">
                                        ...
                                        <span class="counter-label">10 <span>Item(s)</span></span>
            ...
            <div id="sticky-wrapper" class="sticky-wrapper" style="height: 42px;">
                <div class=" header-nav mid-header" style="width: 1093px;">
                    <div class="container">
